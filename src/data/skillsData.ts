...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Zapier', ...L.adv, icon: SiZapier, color: '#FF4A00' },
      { name: 'Power Automate', ...L.adv, icon: FaMicrosoft, color: '#0066FF' },
      { name: 'Power Apps', ...L.int, icon: FaMicrosoft, color: '#742774' },
      { name: 'SAP & SAP Business One', ...L.int, icon: SiSap, color: '#0FAAFF' },
      { name: 'Epicor / Epicor Kinetic', ...L.adv, icon: FaCubes, color: '#0f1b61' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'SharePoint', ...L.adv, icon: FaMicrosoft, color: '#0078D4' },
      { name: 'Ubuntu', ...L.adv, icon: SiUbuntu, color: '#E95420' },
      { name: 'CentOS', ...L.adv, icon: SiCentos, color: '#262577' },
      { name: 'Linux Mint', ...L.adv, icon: SiLinuxmint, color: '#87CF3E' },
      { name: 'Kali Linux', ...L.adv, icon: SiKalilinux, color: '#557C94' },
